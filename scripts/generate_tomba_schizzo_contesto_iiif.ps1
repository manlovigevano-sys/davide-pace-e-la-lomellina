...
$itemPid = 'tomba-schizzo-contesto'
$source = 'assets/images/tomba-abbraccio/archivio/FDP_B06_F145_UD005_MASTER_R.jpg'
$label = "Schizzo della disposizione del corredo della Tomba dell'abbraccio"
$width = 2140
$height = 2679
...
magick $source -auto-orient -strip "$imageRoot/full/$width,/0/default.jpg"
...
$info = [ordered] @{
  ...
  height = $height
  sizes = @(
    [ordered] @{ width = 250; height = 313 }
    [ordered] @{ width = 1140; height = 1427 }
...
$metadata = @(
  ...
  [ordered] @{ label = 'Tipologia'; value = 'schizzo manoscritto' }
  [ordered] @{ label = 'Archivio / istituto'; value = 'Archivio Davide Pace' }
  [ordered] @{ label = 'Riferimento'; value = 'Fondo Pace, Davide, b. 6, fasc. 145, doc. 5' }
  [ordered] @{ label = 'File sorgente'; value = 'FDP_B06_F145_UD005_MASTER_R.jpg' }
)
